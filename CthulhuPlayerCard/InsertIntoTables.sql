	...
	insert into Imiona(Id_imienia, Imie, Pochodzenie_imienia, Plec_imienia) values(6,'Elzbieta','Polish','F');
	...
	insert into Typy_przedmiotow(Id_typu, Nazwa_typu) values(1, 'Watch');
	insert into Typy_przedmiotow(Id_typu, Nazwa_typu) values(2, 'Revolver');
	insert into Typy_przedmiotow(Id_typu, Nazwa_typu) values(3, 'Badge');
